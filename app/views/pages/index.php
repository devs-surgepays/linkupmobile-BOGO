...
<section class="hero-banner py-5 bg-white">
    <div class="container text-center py-5">
        ...
        <!-- <p class="lead text-dark mx-auto mb-5 franklin-family" style="max-width: 900px; font-weight: 500;">
            ...
            and your second month completely free! Don't miss out, get started today.
        </p> -->
...
<!-- Section for promotional details -->
<section class="promo-details py-5" style="background: url('<?php echo URLROOT; ?>/img/home_background.png') no-repeat center; background-size: cover;">
    <div class="container">
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <div class="broadband-label-card bg-white rounded-3 shadow-sm mx-auto mb-5 collapse" style="max-width: 362px;" id="broadbandCard">
                            ...
                            <div class="p-3 " style="border:2px solid;border-radius: 0 0 0.5rem 0.5rem;">
                                <h1 class="fw-bold border-bottom border-dark border-4 mb-1 pb-1">Broadband Facts</h1>

                                <div class="mb-2">
                                    <span class="fw-bold">LinkUp Mobile</span><br>
                                    <span class="fw-bold">Premium - $30 / 12GB</span><br>
                                    <span class="fw-bold">Mobile</span> Broadband Consumer Disclosure
                                </div>

                                <table class="table table-sm table-borderless mb-0">
                                    <tr class="border-bottom border-top border-dark border-bottom-5 border-top-8">
                                        <td class="fw-bold py-1">Monthly Price</td>
                                        <td class="text-end fw-bold  py-1">$30.00</td>
                                    </tr>
                                </table>

                                <p class="x-small-text my-2 border-bottom border-dark border-bottom-3 pb-2">
                                    This monthly price <span class="fw-bold">is not</span> an introductory rate.<br>
                                    This monthly price <span class="fw-bold">does not</span> require a contract.<br>
                                ...
                                <table class="table table-sm table-borderless x-small-text mb-0">
                                    ...
                                    <tr>
                                        <td class="ps-3" style="height: 25px;">Provider Monthly Fees</td>
                                        <td class="text-end">$0.00</td>
                                    </tr>

                                    <tr style="height: 35px;">
                                        <td class="fw-bold pt-2 ps-3">One-Time Fees at Time of Purchase</td>
                                        <td></td>
                                    </tr>
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Federal Universal Service Fund
                                            <hr>
                                        </td>
                                        <td class="text-end">$0.00
                                            <hr>
                                    ...
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Regulatory Cost Recovery
                                            <hr>
                                        </td>
                                        <td class="text-end">$0.00
                                            <hr>
                                    ...
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Early Termination Fees
                                            <hr>
                                        </td>
                                        <td class="text-end">$0.00
                                            <hr>
                                    ...
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Government Taxes</td>
                                        <td class="text-end">Varies by location</td>
                                    </tr>
                                </table>

                                <div class="fw-bold pt-2 mb-2 border-top border-dark border-top-3">Discounts & Bundles</div>
                                <p class="x-small-text my-1 pb-1 ps-3">
                                    Visit the link below for available billing discounts and pricing options for broadband service bundled with other services like video, phone, and wireless service, and use of your own equipment.<br><a href="https://linkupmobile.com/plans/" class="text-primary">https://linkupmobile.com/plans/</a>
                                </p>

                                <div class="fw-bold pt-2 mb-2 border-top border-dark border-top-3">Speed Provided with Plan</div><!-- border-bottom border-dark border-2 -->
                                <table class="table table-sm table-borderless x-small-text mb-0">
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Typical Download Speed
                                            <hr>
                                        </td>
                                    ...
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Typical Upload Speed
                                            <hr>
                                        </td>
                                    ...
                                    <tr style="height: 25px;">
                                        <td class="ps-3">Typical Latency</td>
                                ...
                                <table class="table table-sm table-borderless mb-2 border-top border-dark border-top-2">
                                    <tr>
                                        <td class="fw-bold  pt-2">Data Included with Monthly Price</td>
                                        <td class="text-end fw-bold  pt-2">12 GB</td>
                                    </tr>
                                    <tr class="x-small-text">
                                        <td class="ps-3">Charges for Additional Data Usage</td>
                                        <td class="text-end">$2.00 / GB</td>
                                    </tr>
                                    <tr>
                                        <td class="ps-3"><small>*Customer must purchase Link Up Data Add-On</small></td>
                                    </tr>
                                </table>
                                ...
                                <div><span class="ps-3">Phone: <a href="tel: +19045960304" class="text-primary fs-medium">(904) 596-0304</a></span></div>
                                <div class=" mb-2"><span class="ps-3">Website: <a href="https://linkupmobile.com/" class="text-primary fs-medium">https://linkupmobile.com/</a></span></div>
                                <div class="pt-2 border-top border-dark border-top-8">Learn about the terms used on this label. Visit the Federal Communications Commission’s Consumer Resource Center.</div>
                ...
                <div class="carousel-item active">
                    ...
                    <!-- <div class="px-0 pe-md-2 mt-0 mb-2 mb-md-0 d-flex align-items-center justify-content-around bg-primary text-white rounded-4" style="background-color: #0076bd !important;">
                        <img src="<?php //echo URLROOT; 
                                    ?>/img/phone-icon.png" alt="Phone Icon" class="img-fluid" style="width:95px">
                        <h2 class="display-5 fw-bold text-uppercase">Unlimited<br>Talk and Text</h2>
                        <img src="<?php //echo URLROOT; 
                                    ?>/img/speech-bubbles.png" alt="Chat bubbles" class="img-fluid" style="width:95px">
                    </div> -->
                </div>
...
<script>
    ...
    <img src="https://flagcdn.com/24x18/${country.id}.png" class="me-2"> ${country.en}`;

        // Mostrar y actualizar info inferior
        infoContainer.classList.remove('d-none');
        //document.getElementById('info-flag').innerText = country.emoji;
        document.getElementById('info-flag').innerHTML = `<img src="https://flagcdn.com/80x60/${country.id}.png" alt="${country.en}">`;
        // Cambia el texto según el idioma que necesites
        if (lang === 'en') {
            document.getElementById('info-prevtext').innerText = `Enjoy`;
            document.getElementById('info-text').innerHTML = country.leyenden;
            document.getElementById('info-subtext').innerText = `in ${country.en}`;
        } else {
            document.getElementById('info-prevtext').innerText = `Disfruta`;
            document.getElementById('info-text').innerHTML = country.leyendes;
