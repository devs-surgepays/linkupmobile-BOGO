    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4 text-center">
                <img src="<?php echo URLROOT; ?>/img/linkup-white.png" class="img-fluid" style="max-height: 97px;" />
            </div>

            <div class="col-12 col-md-4 d-flex flex-column align-items-center justify-content-md-end">
