...
define('DB_USER', 'ambassadorlinkup');

define('DB_PASS', ']?H8&*%u!kTg');

define('DB_NAME', 'ambassadorlinkup_ambassador');
...
// URL Root
define('URLROOT', 'https://ambassador.linkupmobile.com/');

// Site Name
define('SITENAME', 'Ambassador LinkupMobile');
